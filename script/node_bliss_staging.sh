...
### BEGIN INIT INFO
# Provides:          node_bliss_staging
# Required-Start:    $remote_fs $named $syslog
# Required-Stop:     $remote_fs $named $syslog
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: Init script for bliss staging node.js server
# Description:       Runs the staging server for Bliss
### END INIT INFO
...
DAEMON_ARGS="/home/suttree/public_html/bliss-staging.troisen.com/current/server.js staging"  # path to your node.js server/app

DESC="Bliss staging node.js server"         # whatever fancy description you like
