...
### BEGIN INIT INFO
# Provides:          node_bliss_production
# Required-Start:    $remote_fs $named $syslog
# Required-Stop:     $remote_fs $named $syslog
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: Init script for bliss production node.js server
# Description:       Runs the production server for Bliss
### END INIT INFO
...
DAEMON_ARGS="/home/suttree/public_html/bliss.troisen.com/current/server.js production" # path to your node.js server/app

DESC="Bliss production node.js server"         # whatever fancy description you like
