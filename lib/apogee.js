...
function update_location(event) {
  ...
  for (var id in event.player) {
    ...
    var dot = '<div id="' + id + '" style="position:absolute;width:' + dot_size + 'px;height:' + dot_size + 'px;top:' + point.y + 'px;left:' + point.x + 'px;background:' + colour + ' "><img src="/images/10px-orange.png" alt="' + dot_meta + '" title="' + dot_meta + '" /></div>';
