...
function update_location(event) {
  ...
  for (var id in event.player) {
    ...
    if (point.x && point.y) {
      ...
      var player_div = '<div id="' + id + '" class="' + dot.klass + '" style="position:absolute;width:' + dot.size + 'px;height:' + dot.size + 'px;top:' + point.y + 'px;left:' + point.x + 'px;"><img src="/images/10px-' + colour + '.png" align="middle" valign="middle" alt="' + dot.meta + '" title="' + dot.meta + '" /></div>';
